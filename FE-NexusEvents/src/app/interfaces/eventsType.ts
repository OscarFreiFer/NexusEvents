...
export const eventsType: EventsType[] = [
    {
        ...
        name: 'Deportivos',
        icon: 'sports_soccer',
        image: 'url(../../assets/imagenes-cards/1.2.png)',
        description:
    ...
    },
    {
        ...
        icon: 'apartment',
        image: 'url(../../assets/imagenes-cards/2.png)',
        description:
    ...
    },
    {
        ...
        image: 'url(../../assets/imagenes-cards/3.png)',
        description:
        ...
        imageProjects: 'url(../../assets/imagenes-dashboard/mercedes.jpg)',
    },
];
